...
if a=="rootjiege"then
_G.whitelisted=true
elseif a=="jg_nb4"then--想接着加的话就复制这一行
_G.whitelisted=true--还有这
end
if _G.whitelisted==true then
local OrionLib = loadstring(game:HttpGet(('https://pastebin.com/raw/KuEsRX44')))()
local Window = OrionLib:MakeWindow({Name = '杰HUB', HidePremium = false, SaveConfig = true, ConfigFolder = 'OrionTest', IntroText = '杰HUB BY 杰'})
...
Home:AddParagraph('杰哥制作','官方QQ群189714343')
Home:AddDropdown({
    Name = '脚本',
    Default = '',
    ...
    if Value == '俄亥俄州' then
local OrionLib = loadstring(game:HttpGet(('https://pastebin.com/raw/KuEsRX44')))()
local Window = OrionLib:MakeWindow({Name = '杰HUB|OHIO', HidePremium = false, SaveConfig = true, ConfigFolder = 'OrionTest', IntroText = '杰HUB|OHIO'})
...
game:GetService('Players').LocalPlayer.PlayerGui.Money.Container.premium.TextLabel.Text = 'OHIO.杰'
...
game:GetService('Workspace').BlackMarket.BlackMarketBillboard.TopLabel.Text = '杰黑市'
game:GetService('Workspace').BlackMarket.BlackMarketBillboard.BottomLabel.Text = '向杰哥出售物品以获得钱!'
game:GetService('Workspace').OhioSign.Screen.SurfaceGui.Frame.Population.Text = '杰哥祝您玩的愉快'
...
scriptName.Text = 'SKIN:杰|MAKE:Charlie'
...
game.Players.LocalPlayer:Kick(a.."你没有被列入白名单，请购买或者找群主反馈")--里面是因为没白名单踢出的数字可以更改
end